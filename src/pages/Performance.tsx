  ...
  return (
    <div className="space-y-6">
      ...
      <section className="grid gap-4 md:grid-cols-3 xl:grid-cols-5">
        ...
        <StatCard label={t("bestQuarter")} value={best ? percent(best.portfolioReturn) : "-"} />
        <StatCard label={t("worstQuarter")} value={worst ? percent(worst.portfolioReturn) : "-"} />
      </section>
