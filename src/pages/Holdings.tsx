  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col justify-between gap-4 lg:flex-row lg:items-end">
        <div>
          <h2 className="text-2xl font-semibold text-ink">{t("currentHoldings")}</h2>
          <p className="mt-1 text-sm text-stone-500">{t("currentHoldingsSubtitle")}</p>
        </div>
        <label className="relative block lg:w-80">
          <span className="sr-only">{t("searchHoldings")}</span>
